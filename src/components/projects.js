  ...
  return (
    <div className="container p-2 d-flex align-items-center justify-content-center">
      <div className="row d-flex justify-content-center project-content">
        <div className="col-6 d-flex justify-content-center align-items-center flex-wrap animate__animated animate__bounceInLeft">
        ...
        <div className="col-6 d-flex justify-content-center align-items-center flex-wrap animate__animated animate__bounceInRight">
